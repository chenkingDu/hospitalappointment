		          ...
		          <TD>
		            <TABLE cellSpacing=0 cellPadding=2 border=0>
			              ...
			              <TR>
			                <TD></TD>
			                <TD>
			                   <img src="<%=path %>/img/login_button.gif" style="BORDER-TOP-WIDTH: 0px; BORDER-LEFT-WIDTH: 0px; BORDER-BOTTOM-WIDTH: 0px; BORDER-RIGHT-WIDTH: 0px" onclick="check1('<%=path %>')"/>
