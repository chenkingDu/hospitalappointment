...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body leftmargin="8" topmargin="8" background='<%=path %>/img/allbg.gif'>
			...
			<form action="<%=path %>/koufei.action" name="ff" method="post">
			    <input type="hidden" name="binglihao" value="${request.binglihao }"/>
			    <input type="button" value="扣费" style="width: 123px;" onclick="koufei()" />
			</form>
			</c:if>
